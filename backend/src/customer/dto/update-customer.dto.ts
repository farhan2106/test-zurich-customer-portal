...
export class UpdateCustomerDto {
  ...
  @ApiPropertyOptional({ description: 'Customer last name', example: 'bin Abdullah', maxLength: 100 })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  lastName?: string;

  @ApiPropertyOptional({ description: 'Google profile photo URL', example: 'https://...', maxLength: 500 })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  photoUrl?: string;

  @ApiPropertyOptional({ description: 'Customer location', enum: CustomerLocation, example: 'West Malaysia' })
  @IsOptional()
  @IsEnum(CustomerLocation)
  location?: CustomerLocation;

  @ApiPropertyOptional({ description: 'Total premium paid (MYR)', example: 2500.00, minimum: 0 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  premiumPaid?: number;
